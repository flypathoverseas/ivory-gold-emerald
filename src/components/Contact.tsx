          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full rounded-xl border px-4 py-3 text-sm text-cream focus:border-gold focus:outline-none bg-onyx/40 ${errors.visaType ? "border-rose-500/60" : "border-cream/15"}`}
                >
                  {visaOptions.map((option) => (
                    <option key={option} value={option} className="bg-onyx text-cream">
                      {option}
                    </option>
                  ))}
                </select>
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className={`w-full rounded-xl border px-4 py-3 text-sm text-cream placeholder:text-cream/40 focus:border-gold focus:outline-none bg-onyx/40 ${errors.message ? "border-rose-500/60" : "border-cream/15"}`}
              />
              {errors.message ? (
            ...
            <button
              ...
              className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full btn-emerald px-6 py-4 text-xs font-semibold uppercase tracking-[0.25em] transition duration-200 hover:scale-[1.01] hover:bg-emerald-base disabled:pointer-events-none disabled:opacity-70"
            >
  ...
  return (
    <div>
      ...
      <input
        ...
        className={`w-full rounded-xl border px-4 py-3 text-sm text-cream placeholder:text-cream/40 focus:border-gold focus:outline-none bg-onyx/40 ${error ? "border-rose-500/60" : "border-cream/15"}`}
      />
