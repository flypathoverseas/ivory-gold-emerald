    ...
    <main>
      ...
      <section className="bg-onyx py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            ...
            <h2 className="mt-3 font-display text-4xl text-cream sm:text-5xl">Engineering <span className="italic text-gradient-gold">approvals</span>, not applications.</h2>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={s.l} className="rounded-2xl border border-cream/10 bg-charcoal/60 p-7">
                <div className="font-display text-4xl text-gradient-gold">{s.v}</div>
                <div className="mt-2 text-[10px] uppercase tracking-[0.25em] text-cream/60">{s.l}</div>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="bg-charcoal py-28">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <h2 className="mt-4 font-display text-4xl text-cream sm:text-5xl leading-tight">
